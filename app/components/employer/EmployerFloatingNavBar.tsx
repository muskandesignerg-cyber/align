/**
 * EmployerFloatingNavBar — Premium pill navbar for employer screens.
 *
...
export default function EmployerFloatingNavBar({ state, descriptors, navigation }: BottomTabBarProps) {
  return (
...
const S = StyleSheet.create({
  ...
  activePill: {
    ...
    ...Platform.select({
      ...
      default: { shadowColor: '#4F46E5', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 14, elevation: 6 },
    }),
  },
